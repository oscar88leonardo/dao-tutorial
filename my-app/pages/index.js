...
export default function Home() {
  ...
  // True if user has connected theri wallet, false otherwise
  ...
  // Reads the ETH balance of the DAO contrct and sets the 'treasuryBalance' state variable
  ...
  // Reads the balance of user's CryptoDevs NFTs and sets the 'nftBalance' state variable
  ...
  const fetchProposalById = async (id) => {
    try{
      ...
      const parseProposal = {
        proposalId: id,
        fakeNftTokenId: proposal.fakeNftTokenId.toString(),
  ...
  // Runs a loop 'numProposals' time to fetch all proposals in the DAO
